...
class AceptPaseadorFragment : Fragment() {
    ...
    private lateinit var btnLlegada: Button
    ...
    override fun onCreateView(
        ...
        view = inflater.inflate(R.layout.fragment_acept_paseador, container, false);
        return view;
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnLlegada = view.findViewById(R.id.btn_llegada);
